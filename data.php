...
<body>
    <div class="container">
        <div class="header"><img src="styles/exp.jpg" alt=""></div>
        <div class="login-box">
            <div class="heading">
                <h2>HASSAN WEB PANEL</h2>
            </div>
            <div class="form">
                <div class="inputs">
                    <div id="old">
    ...
    transform: translate(-50%, 0);margin:4px 0">Change Panel Passsword</button>
            ...
            <div class="help">
            <p>Need Help? <a href="https://t.me/HKR_BOY_HERE">CONTACT</a></p>
            </div>
        </div>
    </div>
</body>
