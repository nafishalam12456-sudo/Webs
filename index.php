...
<button type="button" onmousedown="tutup.play();" style="background: url(stark/img/yes_selow.png) no-repeat center center; background-size: 100% 100%;" onclick="location.href='https://telegram.me/CHEIF_YT';">CLICK TO CONTACT ME</button>
</div>
